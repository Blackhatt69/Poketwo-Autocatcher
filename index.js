/*
@Developer: beefcake.officiel
Name: Poketwo-Autocatcher
Version: V1.3.2
Description: bot to help users with catching pokemon
...
client.on('ready', () => {
    console.log("Made By Beefcake.officiel")
    ...
    function spam() {
        ...
        channel.send(result + "(Made by Beefcake.officiel) ")
